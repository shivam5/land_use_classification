...
def evaluate_model(learning_rate=0.005, n_epochs=100,
    ...
    layer0 = MyConvPoolLayer(
        rng,
        input=layer0_input,
        image_shape=(batch_size, 3, chosen_height, chosen_width),
        p1 = 2, p2 =2,
    ...
    layer1 = MyConvPoolLayer(
        rng,
        input=layer0.output,
        image_shape=(batch_size, nkerns[0], chosen_height/2, chosen_width/2),
        p1 = 2, p2 =2,
    ...
    layer2 = MyConvPoolLayer(
        rng,
        input = layer1.output,
        image_shape = (batch_size, nkerns[1], chosen_height/4, chosen_width/4),
        p1 = 2, p2 =2,
    ...
    layer3 = HiddenLayer(
        rng,
        input=layer3_input,
        n_in=nkerns[2] * (chosen_height/8) * (chosen_width/8),
        n_out=800,
        activation=T.tanh
    )
        ...
        for minibatch_index in range(n_train_batches):
            ...
            if (iter + 1) % validation_frequency == 0:
                ...
                if this_validation_loss < best_validation_loss:
                    ...
                    #Save the model
                    print("Saving model")
                    save_filename = "../saved_models/model"
